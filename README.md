...
| Category | Tools |
|---|---|
| 🎨 Frontend | HTML5, CSS3, JavaScript, Vue.js, Nuxt.js, React.js, Three.js |
| 💨 Styling | TailwindCSS, Bootstrap, Ant Design |
| ⚙️ Backend | Node.js, PHP |
| 🗄️ Database | PostgreSQL, MySQL |
| 🐳 DevOps | Docker, DigitalOcean, Git / GitHub |
| 🔧 Tools | NPM, Gulp, jQuery |
| 🖌️ Design | Figma, Adobe Photoshop |
...
## 🏆 GitHub Trophies
![](https://github-profile-trophy.vercel.app/?username=Levi1207&theme=algolia&no-frame=false&no-bg=false&margin-w=4)
